...
"""
    ...
    Description: This routine creates a data base for all the BT-Settl stellar models available
    ...
    python create_stellar_model_db.py --pattern="*.BT-Settl.spec.fits.gz" --output="stellar_models_db.json" -v
    """
...
for model_file in inputdata :
    ...
    models[filename] = stellar_models_lib.get_BTSettl_spectrum_info_from_fits(model_file)
